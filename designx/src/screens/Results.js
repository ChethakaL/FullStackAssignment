...
function Result() {
  ...
  useEffect(() => {
    ...
    fetchProducts();
  }, [searchTerm]); // Include q in the dependency array to refetch when the search term changes
  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      <section className="shop-page">
        <h1 className="heading-text">Result</h1>
            ...
            <Grid container justifyContent="center" spacing={6}>
              {products.map((product) => (
                <Grid key={product._id} item>
                  <div onClick={() => handleShop(product._id)} style={{ width: '290px'}}>
